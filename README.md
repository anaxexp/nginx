...
❗For better reliability we release images with stability tags (`anaxexp/nginx:1.15-X.X.X`) which correspond to [git tags](https://github.com/anaxexp/nginx/releases). We strongly recommend using images only with stability tags. 
...
The list of installed modules: https://github.com/anaxexp/nginx/blob/master/tests/basic/nginx_modules

Include pagespeed module [pre-built for Alpine](https://github.com/anaxexp/nginx-alpine-psol)
